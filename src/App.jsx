...
function App() {
  ...
  return (
    <>
    <div className='md w-full max-w-md mx-auto px-4 py-10 text-black-700 shadow-md  rounded-lg bg-orange-300'>
    <h1 className=' text-2xl mb-3 text-center text-black'>Password generator</h1>
